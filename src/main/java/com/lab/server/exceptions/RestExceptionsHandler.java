...
//	public ResponseEntity<ApiResponse<String>> handleUrlNotFound(NoHandlerFoundException ndfe) {
...
//	public ResponseEntity<ApiResponse<String>> handleNotSupportedHttpMethod(HttpRequestMethodNotSupportedException hrmnse) {
...
//	public ResponseEntity<ApiResponse<String>> handleNotSupportedMediaType(HttpMediaTypeNotSupportedException hmtnse) {
...
//	public ResponseEntity<ApiResponse<String>> handleArgumentNotValid(MethodArgumentNotValidException manve) {
